...
TotalRevenue_CPP = sum(Revenue_CPP);
...
writetable(Tcpp_detail, CPP_file, 'Sheet', sheetName);

% ---- Write total revenue in cell K2 ----
writecell({'Total_Revenue_Rs'}, CPP_file, ...
    'Sheet', sheetName, 'Range','K1');
writematrix(TotalRevenue_CPP, CPP_file, ...
...
TotalRevenue_TOU = sum(Revenue_TOU);
...
writetable(Ttou_detail, TOU_file, 'Sheet', sheetName);

writecell({'Total_Revenue_Rs'}, TOU_file, ...
    'Sheet', sheetName, 'Range','K1');
writematrix(TotalRevenue_TOU, TOU_file, ...
    'Sheet', sheetName, 'Range','K2');
